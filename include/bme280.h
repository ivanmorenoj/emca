/**
 *  This is a library for bme280 sensor
 *  Author: Ivan Moreno
 *  March 2019
...
class bme280 : public ambientSensor {
public:
    bme280();
    bme280(int bme280_addr);
    ~bme280();
    void setAddress(int bme280_addr=0x77);
...
private:  // private variables
    int _fd;
    struct bme280_calib_data _cal;
    struct bme280_raw_data _raw;
    float _temperature;
    float _pressure;
    float _humidity;
};
